...
"https://script.google.com/macros/s/AKfycbwY1KbXj38SLZtzhPaytww9599SNmiLhD5goWFVWmF21O7BILtB1I0HJF1ABXyqcPQbHw/exec";
...
export const submitComplaint = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    const net = getClientNetInfo();

    // ---- Rate limit: 1 submission per device or IP every 24h ----
