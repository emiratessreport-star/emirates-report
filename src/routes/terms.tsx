...
export const Route = createFileRoute("/terms")({
  head: () =>
    buildHead({
      title: "الشروط والأحكام | منصة الشكاوى المستقلة",
      description:
        "الشروط والأحكام الخاصة باستخدام منصة الشكاوى المستقلة، ومسؤوليات كل من المنصة والمستخدم.",
      path: "/terms",
      breadcrumbs: [
        { name: "الرئيسية", path: "/" },
    ...
    <>
      ...
      <article className="container-page prose prose-neutral mx-auto max-w-3xl py-14 leading-8">
        ...
        <p className="mt-2 text-muted-foreground">
          منصة الشكاوى منصة خاصة ومستقلة تمامًا، غير تابعة لأي جهة حكومية في دولة الإمارات
