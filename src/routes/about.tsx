...
export const Route = createFileRoute("/about")({
  head: () =>
    buildHead({
      ...
      title: "من نحن | منصة شكاوى المستهلك",
      
      // 2. وصف جذاب ومحدد ضمن حدود 150-160 حرف لنتائج جوجل
      description:
        "تعرّف على منصة شكاوى المستهلك المستقلة: رؤيتنا ومهمتنا في توثيق شكاوى المستهلكين وحمايتهم وتوفير مساحة آمنة لإيصال صوتهم للشركات الخاصة.",
