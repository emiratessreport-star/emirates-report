...
export const Route = createFileRoute("/faq")({
  head: () =>
    buildHead({
      ...
      title: "الأسئلة الشائعة | منصة التقرير الإماراتي لخدمة المستهلك",

      // 2. وصف شامل وجذاب لنتائج بحث جوجل
      description:
        "إجابات مفصلة وشاملة عن أكثر الأسئلة شيوعًا حول منصة التقرير الإماراتي: كيفية تقديم الشكاوى، شروط الخدمة، والخصوصية.",
